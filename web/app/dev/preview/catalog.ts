...
export const previewCatalog: PreviewEntry[] = [
  ...
  { name: "chat/message-link-card", title: "メッセージへのリンクのカード" },
  { name: "chat/unread-jump-bar", title: "未読へ飛ぶバー" },
  { name: "chat/jump-highlight", title: "飛んできた先の強調" },
  { name: "chat/message-not-found", title: "リンク先のメッセージが見つからない" },
  { name: "chat/reactions", title: "絵文字のリアクション" },
  { name: "chat/reactions-dark", title: "絵文字のリアクション（ダーク）", dark: true },
  ...
  { name: "chat/mobile-unread-jump-bar", title: "未読へ飛ぶバー（モバイル）", mobile: true },
  { name: "chat/mobile-jump-highlight", title: "飛んできた先の強調（モバイル）", mobile: true },
  { name: "chat/mobile-threads", title: "参加しているスレッドの一覧（モバイル）", mobile: true },
  { name: "chat/mobile-reactions", title: "絵文字のリアクション（モバイル）", mobile: true },
  { name: "chat/mobile-reaction-picker", title: "リアクション: 絵文字のピッカー（モバイル）", mobile: true },
